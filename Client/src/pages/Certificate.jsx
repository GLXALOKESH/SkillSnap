          ...
          >
            <div className="mb-8">
              ...
              <p className="text-gray-400">
                Track your learning achievements and blockchain-verified certificates
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.02 }}
              >
                <h3 className="text-lg font-semibold text-pink-400 mb-2">Pending Verification</h3>
                <p className="text-2xl font-bold text-white">{certificates.pending.length}</p>
              </motion.div>
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.02 }}
              >
                <h3 className="text-lg font-semibold text-pink-400 mb-2">Ongoing Courses</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {items.map((item) => (
          ...
          >
            ...
            {type === 'pending' && (
              <>
                <div className={`mb-2 ${item.currentScore < item.requiredScore ? 'text-red-400 font-semibold' : 'text-gray-400'}`}>
                  Required Score: {item.requiredScore}%
                </div>
                <div className={`mb-2 ${item.currentScore < item.requiredScore ? 'text-red-400 font-semibold' : 'text-gray-400'}`}>
                  Current Score: {item.currentScore}%
                </div>
                <div className={`text-sm ${item.currentScore < item.requiredScore ? 'text-red-500' : 'text-pink-400'}`}>
